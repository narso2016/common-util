...
import com.libs.filter.GlobalDBErrorHandler;
...
@Configuration
@EnableCacheConfig
public class AuthenticationConfigDB extends WebMvcConfigurerAdapter {
	...
	@Bean
	public GlobalDBErrorHandler globalErrorHandler( ) {
		return new GlobalDBErrorHandler();
	}
